...
$process = Start-Process -FilePath ".\MovFileIntegrityChecker.CLI\bin\Debug\net9.0\MovFileIntegrityChecker.CLI.exe" -ArgumentList "--help" -NoNewWindow -PassThru -Wait -RedirectStandardInput "y`n"
